...
function Debrief({writeData}) {
    ...
    useEffect (() => {
        writeData();
    }, []); //empty array ensures that useEffect only runs once; when "Debrief" first appears
    ...
    return (
        <Container component="main" maxWidth="md" align="center">
            ...
            <Typography component="h2" variant="h6" align="left">
                ...
                behave in the future, based on what you know about them in the
                ...
                your judgments. This will reveal dimensions and processes that
                shape social thought.
                <br />
                <br />
                <strong>Did we tell you everything?</strong>
                <br /> There was no deception used in this study. Our initial
                description of the study was kept brief to avoid biasing your natural
                ...
                who can be reached at mark.a.thornton@dartmouth.edu if you have
